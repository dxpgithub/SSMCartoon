                        ...
                        <c:forEach items="${costs}" var="c">             
	                        <tr>
	                            ...
	                            <td>                                
	                                ...
	                                <input type="button" value="修改" class="btn_modify" onclick="location.href='toUpdate?id=${c.cost_id}';" />
	                                <input type="button" value="删除" class="btn_delete" onclick="location.href='toDelete?id=${c.cost_id}';" />
	                            </td>
	                        </tr>
                		</c:forEach>  
                    </table>
